...
<nav class="navbar navbar-expand-lg navbar-dark position-fixed" style="width: 100%; background-color:rgba(143, 135, 135, 0.23);">
  <div class="container">
    ...
    <div class="collapse ms-5 navbar-collapse" id="navbarSupportedContent" style="font-size: 20px; " >
      ...
      <div class="d-flex align-items-center gap-3">
        <a href="../auth/login.php" class="btn btn-primary" style="font-size: 15px;">SignIn</a>
      </div>
    </div>
</nav>